export const QuranPersian: string[][] = [
  [
  ...
  [
    ...
    'و اصحاب اَيكه و قوم تُبَّع، همه پيامبران را دروغ شمردند و مستحق وعده عذاب من شدند.',
  ...
  ['ما كوثر را به تو عطا كرديم.', 'پس براى پروردگارت نماز بخوان و قربانى كن‌', 'كه بدخواه تو خود اَبتر است.'],
  ...
  ['بگو: اوست خداى يكتا،', 'خداى كه در حاجت به او رو كنند،', 'نه زاده است و نه زاده شده،', 'و نه هيچ كس همتاى اوست.'],
